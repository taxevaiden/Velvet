...
A library providing cross-platform window management, built with SDL3. It provides all of the native windowing handles and OpenGL functions necessary to initialize a `BoistRenderer` (or to use any graphics library you may use!).
