...
namespace Boist.Graphics
{
    ...
    public partial class Renderer : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a BoistRenderer with a BoistWindow.
        /// </summary>
        ...
        /// <param name="environment">The BoistRendererEnvironment required to initialize a <see cref="Renderer"/></param>
        ...
        /// <summary>
        /// Initializes a BoistRenderer with the specified GraphicsAPI with a BoistWindow.
        /// </summary>
        /// <param name="environment">The BoistRendererEnvironment required to initialize a <see cref="Renderer"/></param>
        /// <param name="graphicsAPI">The GraphicsAPI to use.</param>
        ...
        /// <summary>
        /// Clears up the resources used for the BoistRenderer.
        /// </summary>
        public void Dispose()
        {
