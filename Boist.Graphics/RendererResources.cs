...
namespace Boist.Graphics
{
    public partial class Renderer : IDisposable
    {
        ...
        private void InitVeldrid_WIN(GraphicsAPI api, RendererEnvironment environment, bool vsync)
        {
        ...
        private void InitVeldrid_LINUX(GraphicsAPI api, RendererEnvironment environment, bool vsync)
        {
        ...
        private void InitVeldrid_OSX(GraphicsAPI api, RendererEnvironment environment, bool vsync)
        {
        ...
        private GraphicsDevice CreateD3D11Device(RendererEnvironment environment, bool vsync)
        {
        ...
        private GraphicsDevice CreateVulkanDevice(RendererEnvironment environment, bool vsync, SwapchainSource source)
        {
        ...
        private GraphicsDevice CreateMetalDevice(RendererEnvironment environment, bool vsync)
        {
            var options = MakeOptions(vsync);
        ...
        private GraphicsDevice CreateOpenGLDevice(RendererEnvironment environment, bool vsync)
        {
        ...
        private void CreateResources()
        {
            ...
            DefaultTexture = new Textures.Texture(this, [255, 255, 255, 255], 1, 1);
            CurrentTexture = DefaultTexture;

            DefaultShader = new Shaders.Shader(this, null, null);
