...
namespace Boist.Graphics
{
    ...
    public unsafe class Font : IDisposable
    {
        ...
        /// <summary>
        /// The font size in pixels. This is determined at initialization and cannot be changed. To use a different font size, create a new instance of BoistFont with the desired size.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the BoistFont class from a font file.
        /// </summary>
        /// <param name="renderer">The BoistRenderer to use for creating the texture atlas.</param>
        ...
        /// <summary>
        /// Disposes of the resources used by the BoistFont.
        /// </summary>
        public void Dispose()
        {
