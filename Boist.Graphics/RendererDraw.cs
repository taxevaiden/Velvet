...
namespace Boist.Graphics
{
    public partial class Renderer : IDisposable
    {
        ...
        /// </summary>
        public Textures.Texture DefaultTexture { get; internal set; } = null!;
        internal Textures.Texture CurrentTexture = null!;
        internal RenderTexture? CurrentRenderTarget = null;
        /// <summary>
        /// The default shader used when no shader is applied. This is a simple shader that supports textured and colored rendering.
        /// </summary>
        public Shaders.Shader DefaultShader { get; internal set; } = null!;
        private Shaders.Shader CurrentShader = null!;
        ...
        public void DrawText(Font font, string text, Vector2 position, RgbaColor color) => DrawText(font, text, font.FontSize, position, color);

        /// <summary>Draws a string using a <see cref="Font"/>.</summary>
        public void DrawText(Font font, string text, int pxSize, Vector2 position, RgbaColor color)
        {
